...
set_input_delay  5.0 -setup -clock [get_clocks clk] [all_inputs]
set_output_delay 5.0 -setup -clock [get_clocks clk] [all_outputs]

# Always set the input/output delay as 0 for clock hold checks
set_output_delay 0.0 -hold  -clock [get_clocks clk] [all_outputs] 
set_input_delay  0.0 -hold  -clock [get_clocks clk] [all_inputs]
